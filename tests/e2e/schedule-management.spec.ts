...
test.describe('Schedule Management', () => {
  ...
  test('should create schedule template and assign to employee', async ({ page }) => {
    ...
    const createButton = page.locator('button:has-text("Create Schedule"), button:has-text("Создать график")');
    if (await createButton.isVisible()) {
      ...
      if (await nameInput.isVisible()) {
        ...
        // Submit
        const submitButton = page.locator('button[type="submit"]:has-text("Create"), button[type="submit"]:has-text("Создать")');
    ...
    const assignScheduleButton = page.locator('button:has-text("Assign Schedule"), button:has-text("Назначить график")');
  ...
  test('should generate shifts from schedule', async ({ page }) => {
    ...
    const generateButton = page.locator('button:has-text("Generate Shifts"), button:has-text("Сгенерировать")');
    ...
    if (await generateButton.isVisible()) {
      ...
      if (await startDateInput.isVisible()) {
        ...
        // Submit
        const submitButton = page.locator('button[type="submit"]:has-text("Generate"), button[type="submit"]:has-text("Сгенерировать")');
        if (await submitButton.isVisible()) {
          await submitButton.click();
